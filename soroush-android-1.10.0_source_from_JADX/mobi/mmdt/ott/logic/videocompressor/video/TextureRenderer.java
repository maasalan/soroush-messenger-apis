...
public class TextureRenderer {
    ...
    private static final float[] mTriangleVerticesData = new float[]{-1.0f, -1.0f, 0.0f, 0.0f, 0.0f, BallPulseIndicator.SCALE, -1.0f, 0.0f, BallPulseIndicator.SCALE, 0.0f, -1.0f, BallPulseIndicator.SCALE, 0.0f, 0.0f, BallPulseIndicator.SCALE, BallPulseIndicator.SCALE, BallPulseIndicator.SCALE, 0.0f, BallPulseIndicator.SCALE, BallPulseIndicator.SCALE};
    ...
    private int loadShader(int i, String str) {
        ...
        StringBuilder stringBuilder = new StringBuilder("glCreateShader type=");
    ...
    public void drawFrame(SurfaceTexture surfaceTexture, boolean z) {
        ...
        if (z) {
            ...
            this.mSTMatrix[13] = BallPulseIndicator.SCALE - this.mSTMatrix[13];
        }
    ...
    public void surfaceCreated() {
        ...
        if (this.rotationAngle != 0) {
            Matrix.rotateM(this.mMVPMatrix, 0, (float) this.rotationAngle, 0.0f, 0.0f, BallPulseIndicator.SCALE);
        }
    }
}
