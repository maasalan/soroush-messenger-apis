...
public class SlideInDownAnimator extends BaseItemAnimator {
    ...
    protected void animateRemoveImpl(ViewHolder viewHolder) {
        C0571r.m1380q(viewHolder.itemView).m1418c((float) (-viewHolder.itemView.getHeight())).m1410a(0.0f).m1411a(getRemoveDuration()).m1412a(new DefaultRemoveVpaListener(viewHolder)).m1417b();
    }

    protected void preAnimateAddImpl(ViewHolder viewHolder) {
        C0571r.m1351b(viewHolder.itemView, (float) (-viewHolder.itemView.getHeight()));
