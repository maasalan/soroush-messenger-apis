...
public class OvershootInRightAnimator extends BaseItemAnimator {
    protected void animateAddImpl(ViewHolder viewHolder) {
        C0571r.m1380q(viewHolder.itemView).m1416b(0.0f).m1411a(getAddDuration()).m1412a(new DefaultAddVpaListener(viewHolder)).m1414a(new OvershootInterpolator()).m1417b();
    }
