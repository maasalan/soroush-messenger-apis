...
class C7152k extends C6439h {
    final /* synthetic */ C2354h f20474a;

    C7152k(C2354h c2354h, int i, String str, JSONObject jSONObject, C0993b c0993b, C0992a c0992a) {
        this.f20474a = c2354h;
    ...
    public Map<String, String> getHeaders() {
        ...
        c4813a.put("token", this.f20474a.f7718f);
