...
class Socks5ClientForInitiator extends Socks5Client {
    ...
    public Socks5ClientForInitiator(StreamHost streamHost, String str, XMPPConnection xMPPConnection, String str2, i iVar) {
    ...
    public Socket getSocket(int i) {
        Socket socket;
        if (this.streamHost.getJID().a(((XMPPConnection) this.connection.get()).getUser())) {
