...
public class Subscription extends NodeExtension {
    ...
    private static void appendAttribute(StringBuilder stringBuilder, String str, String str2) {
    ...
    public String toXML() {
        ...
        appendAttribute(stringBuilder, ParserUtils.JID, this.jid);
        if (getNode() != null) {
            appendAttribute(stringBuilder, NodeElement.ELEMENT, getNode());
        }
        if (this.id != null) {
