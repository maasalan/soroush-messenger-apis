...
import android.support.v7.p042b.C0680a.C0677b;
...
class RoundRectDrawableWithShadow extends Drawable {
    ...
    RoundRectDrawableWithShadow(Resources resources, ColorStateList colorStateList, float f, float f2, float f3) {
        this.mShadowStartColor = resources.getColor(C0676a.cardview_shadow_start_color);
        this.mShadowEndColor = resources.getColor(C0676a.cardview_shadow_end_color);
        this.mInsetShadow = resources.getDimensionPixelSize(C0677b.cardview_compat_inset_shadow);
    ...
    private void buildShadowCorners() {
        ...
        r0.mCornerShadowPaint.setShader(new RadialGradient(0.0f, 0.0f, r0.mCornerRadius + r0.mShadowSize, new int[]{r0.mShadowStartColor, r0.mShadowStartColor, r0.mShadowEndColor}, new float[]{0.0f, f, BallPulseIndicator.SCALE}, TileMode.CLAMP));
        r0.mEdgeShadowPaint.setShader(new LinearGradient(0.0f, (-r0.mCornerRadius) + r0.mShadowSize, 0.0f, (-r0.mCornerRadius) - r0.mShadowSize, new int[]{r0.mShadowStartColor, r0.mShadowStartColor, r0.mShadowEndColor}, new float[]{0.0f, 0.5f, BallPulseIndicator.SCALE}, TileMode.CLAMP));
