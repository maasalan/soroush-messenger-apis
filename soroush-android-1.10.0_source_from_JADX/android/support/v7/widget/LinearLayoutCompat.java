...
public class LinearLayoutCompat extends ViewGroup {
    ...
    public static class LayoutParams extends MarginLayoutParams {
        ...
        public LayoutParams(Context context, AttributeSet attributeSet) {
            ...
            this.gravity = -1;
            TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0644j.LinearLayoutCompat_Layout);
            this.weight = obtainStyledAttributes.getFloat(C0644j.LinearLayoutCompat_Layout_android_layout_weight, 0.0f);
            this.gravity = obtainStyledAttributes.getInt(C0644j.LinearLayoutCompat_Layout_android_layout_gravity, -1);
    ...
    public LinearLayoutCompat(Context context, AttributeSet attributeSet, int i) {
        ...
        TintTypedArray obtainStyledAttributes = TintTypedArray.obtainStyledAttributes(context, attributeSet, C0644j.LinearLayoutCompat, i, 0);
        int i2 = obtainStyledAttributes.getInt(C0644j.LinearLayoutCompat_android_orientation, -1);
        if (i2 >= 0) {
            setOrientation(i2);
        }
        i2 = obtainStyledAttributes.getInt(C0644j.LinearLayoutCompat_android_gravity, -1);
        if (i2 >= 0) {
            setGravity(i2);
        }
        boolean z = obtainStyledAttributes.getBoolean(C0644j.LinearLayoutCompat_android_baselineAligned, true);
        if (!z) {
            setBaselineAligned(z);
        }
        this.mWeightSum = obtainStyledAttributes.getFloat(C0644j.LinearLayoutCompat_android_weightSum, -1.0f);
        this.mBaselineAlignedChildIndex = obtainStyledAttributes.getInt(C0644j.LinearLayoutCompat_android_baselineAlignedChildIndex, -1);
        this.mUseLargestChild = obtainStyledAttributes.getBoolean(C0644j.LinearLayoutCompat_measureWithLargestChild, false);
        setDividerDrawable(obtainStyledAttributes.getDrawable(C0644j.LinearLayoutCompat_divider));
        this.mShowDividers = obtainStyledAttributes.getInt(C0644j.LinearLayoutCompat_showDividers, 0);
        this.mDividerPadding = obtainStyledAttributes.getDimensionPixelSize(C0644j.LinearLayoutCompat_dividerPadding, 0);
        obtainStyledAttributes.recycle();
    }
    ...
    void layoutHorizontal(int i, int i2, int i3, int i4) {
        ...
        i7 = C0555d.m1224a(i7, C0571r.m1369h(this));
        int i9 = 1;
        int paddingLeft = i7 != 1 ? i7 != 5 ? getPaddingLeft() : ((getPaddingLeft() + i3) - i) - r6.mTotalLength : (((i3 - i) - r6.mTotalLength) / 2) + getPaddingLeft();
        if (isLayoutRtl) {
            ...
            if (virtualChildAt == null) {
                ...
                if (z) {
                    ...
                    if (layoutParams2.height != -1) {
                        ...
                        setChildFrame(virtualChildAt, virtualChildCount + getLocationOffset(virtualChildAt), i7, measuredWidth, i9);
                        view2 = view;
    ...
    void layoutVertical(int i, int i2, int i3, int i4) {
        ...
        int paddingTop = i5 != 16 ? i5 != 80 ? getPaddingTop() : ((getPaddingTop() + i4) - i2) - r6.mTotalLength : (((i4 - i2) - r6.mTotalLength) / 2) + getPaddingTop();
        int i7 = 0;
        while (i7 < virtualChildCount) {
            int i8;
            ...
            if (virtualChildAt == null) {
                ...
                i8 = C0555d.m1224a(i8, C0571r.m1369h(this)) & 7;
                if (i8 == 1) {
    ...
    void measureHorizontal(int i, int i2) {
            ...
            if (virtualChildAt == null) {
                ...
                if (virtualChildAt.getVisibility() != 8) {
                    ...
                    if (mode == i10 && layoutParams2.width == 0 && layoutParams2.weight > 0.0f) {
                        if (i11 != 0) {
                            i3 = r7.mTotalLength + (layoutParams2.leftMargin + layoutParams2.rightMargin);
                        } else {
                            i3 = r7.mTotalLength;
                            i3 = Math.max(i3, (layoutParams2.leftMargin + i3) + layoutParams2.rightMargin);
                        }
                        r7.mTotalLength = i3;
                        if (z3) {
                        ...
                        if (i11 != 0) {
                            i3 = r7.mTotalLength + (((layoutParams.leftMargin + i12) + layoutParams.rightMargin) + getNextLocationOffset(view));
                        } else {
                            i3 = r7.mTotalLength;
                            i3 = Math.max(i3, (((i3 + i12) + layoutParams.leftMargin) + layoutParams.rightMargin) + getNextLocationOffset(view));
                        }
                        r7.mTotalLength = i3;
                        if (z) {
        ...
        int i23 = (16777215 & i3) - r7.mTotalLength;
        if (i14 == 0) {
            if (i23 == 0 || f <= 0.0f) {
                i10 = Math.max(i10, i5);
                if (z && i12 != 1073741824) {
        ...
        while (i10 < virtualChildCount) {
            ...
            if (virtualChildAt3 == null || virtualChildAt3.getVisibility() == 8) {
                ...
                if (i11 != 0) {
                    measuredHeight = r7.mTotalLength + (((virtualChildAt3.getMeasuredWidth() + layoutParams.leftMargin) + layoutParams.rightMargin) + getNextLocationOffset(virtualChildAt3));
                } else {
                    measuredHeight = r7.mTotalLength;
                    measuredHeight = Math.max(measuredHeight, (((virtualChildAt3.getMeasuredWidth() + measuredHeight) + layoutParams.leftMargin) + layoutParams.rightMargin) + getNextLocationOffset(virtualChildAt3));
                }
                r7.mTotalLength = measuredHeight;
    ...
    void measureVertical(int i, int i2) {
        ...
        i9 = (16777215 & i11) - r7.mTotalLength;
        if (i14 == 0) {
            if (i9 == 0 || f <= 0.0f) {
                i3 = Math.max(i12, i8);
                if (z && i13 != 1073741824) {
                    ...
                    if (layoutParams4.height == 0) {
                        if (i13 == 1073741824) {
                            if (i26 > 0) {
                                ...
                                i9 = View.combineMeasuredStates(i9, virtualChildAt4.getMeasuredState() & -256);
                            } else {
                                i4 = 1073741824;
                                i26 = 0;
                                virtualChildAt4.measure(i17, MeasureSpec.makeMeasureSpec(i26, i4));
