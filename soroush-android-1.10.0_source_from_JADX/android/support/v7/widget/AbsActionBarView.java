...
abstract class AbsActionBarView extends ViewGroup {
    ...
    protected C0579v mVisibilityAnim;
    ...
    protected class VisibilityAnimListener implements C0580w {
        ...
        public VisibilityAnimListener withFinalVisibility(C0579v c0579v, int i) {
            AbsActionBarView.this.mVisibilityAnim = c0579v;
    ...
    AbsActionBarView(Context context, AttributeSet attributeSet, int i) {
        ...
        if (!context.getTheme().resolveAttribute(C0635a.actionBarPopupTheme, typedValue, true) || typedValue.resourceId == 0) {
    ...
    public void animateToVisibility(int i) {
        setupAnimatorToVisibility(i, 200).m1417b();
    }
    ...
    protected void onConfigurationChanged(Configuration configuration) {
        ...
        TypedArray obtainStyledAttributes = getContext().obtainStyledAttributes(null, C0644j.ActionBar, C0635a.actionBarStyle, 0);
        setContentHeight(obtainStyledAttributes.getLayoutDimension(C0644j.ActionBar_height, 0));
    ...
    public void setVisibility(int i) {
        if (i != getVisibility()) {
            if (this.mVisibilityAnim != null) {
                this.mVisibilityAnim.m1415a();
            }
            super.setVisibility(i);
        }
    }

    public C0579v setupAnimatorToVisibility(int i, long j) {
        C0579v a;
        if (this.mVisibilityAnim != null) {
            this.mVisibilityAnim.m1415a();
        }
        if (i == 0) {
            ...
            a = C0571r.m1380q(this).m1410a((float) BallPulseIndicator.SCALE);
        } else {
            a = C0571r.m1380q(this).m1410a(0.0f);
        }
        a.m1411a(j);
        a.m1412a(this.mVisAnimListener.withFinalVisibility(a, i));
        return a;
    }
