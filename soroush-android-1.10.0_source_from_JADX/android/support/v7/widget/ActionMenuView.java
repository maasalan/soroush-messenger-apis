...
public class ActionMenuView extends LinearLayoutCompat implements C0723b, C0729p {
    ...
    private C4890h mMenu;
    C0722a mMenuBuilderCallback;
    ...
    private static class ActionMenuPresenterCallback implements C0726a {
    ...
    private class MenuBuilderCallback implements C0722a {
        MenuBuilderCallback() {
        }
        ...
        public void onMenuModeChange(C4890h c4890h) {
            if (ActionMenuView.this.mMenuBuilderCallback != null) {
                ActionMenuView.this.mMenuBuilderCallback.onMenuModeChange(c4890h);
            }
        }
    }
    ...
    static int measureChildForCells(View view, int i, int i2, int i3, int i4) {
        ...
        boolean z = false;
        boolean z2 = actionMenuItemView != null && actionMenuItemView.m15120b();
        int i5 = 2;
        if (i2 <= 0 || (z2 && i2 < 2)) {
            i5 = 0;
        } else {
    ...
    private void onMeasureExactFormat(int i, int i2) {
        ...
        while (paddingLeft < i3) {
            ...
            if (childAt2.getVisibility() != 8) {
                ...
                z3 = z4 && ((ActionMenuItemView) childAt2).m15120b();
    ...
    public Menu getMenu() {
        if (this.mMenu == null) {
            ...
            this.mMenu.mo2620a(new MenuBuilderCallback());
            this.mPresenter = new ActionMenuPresenter(context);
            this.mPresenter.setReserveOverflow(true);
            this.mPresenter.setCallback(this.mActionMenuPresenterCallback != null ? this.mActionMenuPresenterCallback : new ActionMenuPresenterCallback());
            this.mMenu.m9477a(this.mPresenter, this.mPopupContext);
    ...
    public boolean invokeItem(C4893j c4893j) {
        return this.mMenu.m9481a((MenuItem) c4893j, null, 0);
    }
