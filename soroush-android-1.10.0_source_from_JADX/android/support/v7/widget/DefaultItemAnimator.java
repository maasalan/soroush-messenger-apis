...
public class DefaultItemAnimator extends SimpleItemAnimator {
    ...
    private boolean endChangeAnimationIfNecessary(ChangeInfo changeInfo, ViewHolder viewHolder) {
        ...
        viewHolder.itemView.setAlpha(BallPulseIndicator.SCALE);
    ...
    void animateAddImpl(final ViewHolder viewHolder) {
        ...
        animate.alpha(BallPulseIndicator.SCALE).setDuration(getAddDuration()).setListener(new AnimatorListenerAdapter() {
    ...
    void animateChangeImpl(final ChangeInfo changeInfo) {
        ...
        if (view2 != null) {
            ...
            duration.alpha(0.0f).setListener(new AnimatorListenerAdapter() {
                public void onAnimationEnd(Animator animator) {
                    ...
                    view2.setAlpha(BallPulseIndicator.SCALE);
        ...
        if (view != null) {
            ...
            animate.translationX(0.0f).translationY(0.0f).setDuration(getChangeDuration()).alpha(BallPulseIndicator.SCALE).setListener(new AnimatorListenerAdapter() {
                public void onAnimationEnd(Animator animator) {
                    animate.setListener(null);
                    view.setAlpha(BallPulseIndicator.SCALE);
        ...
        if (isRunning()) {
            ...
            for (size = this.mAdditionsList.size() - 1; size >= 0; size--) {
                ...
                for (int size3 = arrayList.size() - 1; size3 >= 0; size3--) {
                    ...
                    viewHolder2.itemView.setAlpha(BallPulseIndicator.SCALE);
    ...
    public void runPendingAnimations() {
        ...
        if (isEmpty != 0 || isEmpty2 != 0 || isEmpty4 != 0 || isEmpty3 != 0) {
            ...
            if (isEmpty2 != 0) {
                ...
                if (isEmpty != 0) {
                    C0571r.m1344a(((MoveInfo) arrayList.get(0)).holder.itemView, c07481, getRemoveDuration());
                } else {
                    c07481.run();
                }
            }
            if (isEmpty3 != 0) {
                ...
                if (isEmpty != 0) {
                    C0571r.m1344a(((ChangeInfo) arrayList.get(0)).oldHolder.itemView, c07481, getRemoveDuration());
                } else {
                    c07481.run();
                }
            }
            if (isEmpty4 != 0) {
                ...
                C0571r.m1344a(((ViewHolder) arrayList2.get(0)).itemView, c07503, removeDuration + Math.max(moveDuration, j));
            }
        }
    }
}
