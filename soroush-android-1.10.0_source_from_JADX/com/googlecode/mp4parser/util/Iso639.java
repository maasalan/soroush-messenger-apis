...
public class Iso639 {
    ...
    static {
        ...
        doublePut("hu", "hun");
        doublePut("ia", "ina");
        doublePut(MessageCorrectExtension.ID_TAG, "ind");
        doublePut("ie", "ile");
        doublePut("ga", "gle");
        doublePut("ig", "ibo");
        doublePut("ik", "ipk");
        ...
        doublePut("no", "nor");
        doublePut("ii", "iii");
        doublePut(Base64BinaryChunk.ATTRIBUTE_NR, "nbl");
        doublePut("oc", "oci");
        doublePut("oj", "oji");
        doublePut("cu", "chu");
        doublePut("om", "orm");
        ...
        doublePut("sd", "snd");
        doublePut("se", "sme");
        doublePut(StreamManagementFeature.ELEMENT, "smo");
        doublePut("sg", "sag");
        doublePut("sr", "srp");
        doublePut("gd", "gla");
        doublePut("sn", "sna");
        doublePut(StreamInitiation.ELEMENT, "sin");
        doublePut("sk", "slk");
        doublePut("sl", "slv");
        doublePut("so", "som");
        doublePut("st", "sot");
        ...
        doublePut("tl", "tgl");
        doublePut("tn", "tsn");
        doublePut(PrivacyItem.SUBSCRIPTION_TO, "ton");
        doublePut("tr", "tur");
        doublePut("ts", "tso");
        doublePut("tt", "tat");
        doublePut("tw", "twi");
